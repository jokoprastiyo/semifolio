...
function semifolio_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'footer-widget',
		'description'   => '',
		'before_widget' => '<div class="container"><div class="row"><div class="col-md-4"><aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside></div></div></div>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	));
...
function semifolio_scripts(){
	...
	wp_enqueue_script( 'semifolio_custom_js', get_template_directory_uri() . '/inc/js/custom.js', array( 'jquery' ), '20150615', true );
